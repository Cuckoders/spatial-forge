...
const familyHouse: ProjectDocument = {
  ...
  utilities: [], utilityDevices: [], utilityRisers: [], utilityJunctions: [],
};
...
const blankProject: ProjectDocument = {
  ...
  floors: [createPlanFloor('blank-floor', '1 этаж', 0)], rooms: [], walls: [], wallOpenings: [], wallFinishes: {}, openings: [], modelInstances: [], utilities: [], utilityDevices: [], utilityRisers: [], utilityJunctions: [],
};
